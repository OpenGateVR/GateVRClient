...
pub fn raycast_grab(objects: &mut Vec<Object>, position: (f32, f32, f32), direction: cgmath::Vector3<f32>, max_distance: usize) -> usize {
    ...
    position_checking.0 = (position.0 + direction.x) as f64;
    position_checking.1 = (position.1 + direction.y) as f64;
    position_checking.2 = (position.2 + direction.z) as f64;
    for _ in 0..max_distance {
        ...
        position_checking.0 += direction.x as f64;
        position_checking.1 += direction.y as f64;
        position_checking.2 += direction.z as f64;
    }
    0
}